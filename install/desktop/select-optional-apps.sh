...
# Install all desktop applications directly
source "$BTW_PATH/install/desktop/optional/app-proton-pass.sh"
...
source "$BTW_PATH/install/desktop/optional/app-windows.sh"
source "$BTW_PATH/install/desktop/optional/app-asdcontrol.sh"
